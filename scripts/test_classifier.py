...
def process_records_clf_test(folder_input,  folder_models, records, folder_output, config):
...
if __name__ == "__main__":
    for session in sessions:
        ...
        os.makedirs(folder_output, exist_ok=True)
        process_records_clf_test(folder_input, folder_models, records, folder_output, config)
